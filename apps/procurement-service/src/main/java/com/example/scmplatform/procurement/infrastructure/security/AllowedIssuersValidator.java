...
/**
 * Accepts tokens whose {@code iss} claim matches any configured allowed issuer.
 * Mirrors the gateway-service validator at the service level
 * (defense-in-depth — even bypassed traffic must still match the allowlist).
 */
